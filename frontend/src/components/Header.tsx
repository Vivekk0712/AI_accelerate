...
export function Header() {
  ...
  const headerData = {
    ...
    navigation: [
      ...
      { name: "How It Works", href: "#how-it-works", order: 2 },
      { name: "Use Cases", href: "#use-cases", order: 3 },
      { name: "Chat", href: "#chat", order: 4 },
      { name: "Admin", href: "#admin", order: 5 }
    ],
    buttons: {
      contact: {
        text: "Try Demo",
        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <a href="#home" className="flex items-center space-x-3 hover:opacity-80 transition-opacity group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-muted-foreground -mt-1">Powered by Gemini + Elasticsearch</span>
            </div>
          </a>
